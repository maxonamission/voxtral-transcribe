# Story 022: Audio integration tests — end-to-end voice command validation
...
**Keep the guide up to date:** regenerate after any changes to `shared/src/languages/*.json`.
