# Story 023: Audio test diversity — voice variation, accents, and background noise

**Epic:** Testing
**Status:** Backlog
**Priority:** Low
**Estimate:** Medium
**Depends on:** Story 022 (audio integration tests)

## Summary

Story 022 provides baseline TTS-generated test audio with a single voice per language. For robust speech recognition testing, the samples need variation in:
